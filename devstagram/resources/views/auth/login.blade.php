    ...
    <div class="md:flex md:justify-center md:gap-10 md:items-center">
        ...
        <div class="md:w-4/12 bg-white p-6 rounded-lg shadow">
            <form action="{{ route('login')}}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    <input type="checkbox" name="remember" id="">  <label for="remember" class="uppercase text-gray-500 text-sm">
                        Mantener mi sesión abierta
                    </label>
                </div>
                <input type="submit" value="Iniciar Sesión" class="bg-sky-600 hover:bg-sky-700 font-bold uppercase w-full p-3 transition-colors cursor-pointer text-white">
            </form>
        </div>
